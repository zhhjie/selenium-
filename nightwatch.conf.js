...
const seleniumConfig = require('./build/selenium-conf.js')
module.exports = (function (settings) {
    ...
    settings.selenium.cli_args['webdriver.chrome.driver'] = `${path.resolve()}/node_modules/selenium-standalone/.selenium/chromedriver/${seleniumConfig.driver.chrome.version}-chromedriver.exe`
    return settings;
